...
>
  <div
    className="bg-white rounded-lg shadow-lg p-12 max-w-lg w-full relative flex flex-col items-center"
  ...
  >
    ...
    {/* GIF at the top */}
    <img src="/thank.gif" alt="Thank you" className="mb-4 w-84 h-84 object-contain" />

    <h1
      className={`text-lg text-center font-bold text-green-600`}
    >
              ...
              <div className="flex space-x-3">
                ...
                >
                  <FaTiktok size={24} className="fill-coducators-blue stroke-none" />
                                        ...
                                        <div className="bg-white rounded-2xl shadow-md overflow-hidden p-1 dark:bg-gray-900 dark:text-white h-[35vh]">
                              <GoogleMap />
                            </div>
          </div>
        </div>
